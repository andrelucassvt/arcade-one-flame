...
| Arquivo | Quando ler |
|---|---|
| `references/service.md` | Sempre — `PurchaseIds`, `InAppPurchaseService`, contrato `EntitlementService` e `LocalEntitlementService` (🅰) |
...
## Passo 3 — Ordem de implementação

...
class LooseMeteorComponent extends PositionComponent {
  ...
  static final Paint _meteorPaint = Paint()..color = const Color(0xFF8A8797);
  static final Paint _shadowPaint = Paint()..color = const Color(0xFF4B4A5B);
  static final Paint _highlightPaint = Paint()..color = const Color(0xFFC4B9D8);
  ...
  double clearanceTo(Ship ship) {
    ...
    final centerDistance = position.distanceTo(ship.position);
